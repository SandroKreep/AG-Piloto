          ...
          <div key={pedido.id} 
            ...
            {pedido.cliente_whatsapp && (
              <a
                ...
                style={{ color: '#25D366', fontWeight: 600, fontSize: '0.85rem', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '4px', marginTop: '8px' }}
              >
      ...
      {pedidosFiltrados.length === 0 ? (
        ...
        pedidosFiltrados.map((pedido) => (
          <div key={pedido.id} 
            ...
            {pedido.service_type === 'frete' && pedido.foto_url && (
              <img src={pedido.foto_url} alt="Material" style={{ width: 60, height: 60, objectFit: 'cover', borderRadius: '8px', marginTop: '8px' }} />
            )}
            <div className="moto-card__preco">{formatPrice(pedido.quoted_price)}</div>
            {pedido.cliente_whatsapp && (
              <a 
